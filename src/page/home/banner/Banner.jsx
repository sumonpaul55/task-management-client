            ...
            <div className="container mx-auto">
                <div className='flex justify-center'>
                    <div className="mt-40 md:mt-52 text-center" data-aos="fade-up">
                        ...
                        <Link to="dashboard">
                            <button className='px-3 w-auto md:px-10 py-1 bg-teal-600 text-white mt-10 md:py-2 text-xl font-semibold hover:bg-teal-800 duration-200'>Let's Explore</button>
                        </Link>
                    </div>
                </div>
            </div>
