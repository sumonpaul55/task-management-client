    ...
    return (
        <section className='py-32 bg-slate-200 px-2'>
            <div className="container max-w-[1000px] mx-auto">
                ...
                <div className='mt-10'>
                    <div className='grid grid-cols-1 md:grid-cols-2 gap-5 md:gap-9'>
                        <div data-aos="fade-right">
                            <img src={login} alt="" className='max-w-[400px] rounded-md' />
                        </div>
                ...
                <div className='mt-32'>
                    <div className='grid grid-cols-1 justify-center md:grid-cols-2 gap-5 md:gap-9'>
                        ...
                        <div data-aos="fade-left">
                            <img src={dashboard} alt="" className='max-w-[400px] rounded-md' />
                        </div>
                    </div>
                </div>
            </div>
